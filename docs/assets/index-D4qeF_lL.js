...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function T0(s,e,t){const n=new Float32Array(es),i=new R(0,1,0);return new Zn({name:"SphericalGaussianBlur",defines:{n:es,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ba(),fragmentShader:`
...
`)+`
`+A);const y=_+p+o,x=_+A+a,E=Eu(i,i.VERTEX_SHADER,y),M=Eu(i,i.FRAGMENT_SHADER,x);i.attachShader(m,E),i.attachShader(m,M),t.index0AttributeName!==void 0?i.bindAttribLocation(m,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(m,0,"position"),i.linkProgram(m);function v(B){if(s.debug.checkShaderErrors){const D=i.getProgramInfoLog(m)||"",P=i.getShaderInfoLog(E)||"",L=i.getShaderInfoLog(M)||"",Q=D.trim(),N=P.trim(),G=L.trim();let Y=!0,ie=!0;if(i.getProgramParameter(m,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,m,E,M);else{const $=Iu(i,E,"vertex"),Z=Iu(i,M,"fragment");we("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(m,i.VALIDATE_STATUS)+`
